---
name: Implement A2A Remote Agent Orchestration
description: Use this skill when you need to delegate tasks from a central orchestrator agent to a specialized, remote A2A-compliant agent.
---
